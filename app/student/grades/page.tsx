...
const grades = [
  {
    id: "1",
    course: "CS101",
    courseCode: "Introduction to Computer Science",
    grade: "A",
    score: 92,
    credits: 3,
    semester: "Fall 2023",
  },
  { id: "2", course: "MATH201", courseCode: "Calculus II", grade: "A-", score: 89, credits: 4, semester: "Fall 2023" },
  {
    id: "3",
    course: "ENG102",
    courseCode: "English Composition",
    grade: "B+",
    score: 87,
    credits: 3,
...
const gradeTrendData = [
  { course: "CS101", assignment1: 85, assignment2: 88, assignment3: 92 },
  { course: "MATH201", assignment1: 82, assignment2: 85, assignment3: 89 },
  { course: "ENG102", assignment1: 80, assignment2: 84, assignment3: 87 },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border-blue-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Out of 60 required</p>
            </CardContent>
          </Card>
