...
import { useStudentTeachers, type StudentTeacher } from "@/lib/hooks/use-student-teachers"
import { TeacherRatingForm } from "@/components/student/TeacherRatingForm"
...
export function TeachersContent() {
  ...
  const averageRating = teachers.length > 0
    ...
    : 0
  const excellentRatings = teachers.filter((t) => (t.rating || 0) >= 4.5).length
                ...
                <Card className="relative overflow-hidden border-2 border-green-200/50 dark:border-green-800/50 bg-gradient-to-br from-green-50/80 to-white dark:from-green-950/30 dark:to-background shadow-lg hover:shadow-2xl transition-all duration-500 group hover:-translate-y-1 cursor-help">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground mt-2 font-medium">
                      {teachers.length > 0 ? Math.round((excellentRatings / teachers.length) * 100) : 0}% rated 4.5 or higher
                    </p>
                  </CardContent>
                </Card>
              </TooltipTrigger>
                      ...
                      <HoverCardTrigger asChild>
                        ...
                        >
                            ...
                            <div className="flex items-start gap-4">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-2 mt-2">
                                  ...
                                  <span className="text-sm font-bold">{teacher.rating?.toFixed(1) || "N/A"}</span>
                                </div>
                              </div>
                            </div>
                          </CardHeader>
                          ...
                          <CardContent className="space-y-4 relative pt-4">
                            ...
                            {/* Rating Form */}
                            <TeacherRatingForm teacherId={teacher.id} />
                        ...
                        <div className="space-y-3">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-xs text-muted-foreground">{teacher.department || "General"}</p>
                            </div>
                          </div>
                          <Separator />
                          <div>
